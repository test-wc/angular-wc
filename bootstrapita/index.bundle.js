...
.form-check input.semi-checked:not(:checked) + label::after {
  ...
  z-index: 0;
}`;class Ao extends no{static styles=Co;static properties={id:"",label:"",type:{type:String},value:{type:String}};constructor(){super(),this.type="text"}updated(o){o.has("value")&&(this.value&&this.value.length,this.requestUpdate(),this.value!==this._inputElement.value&&(this.value?this._inputElement.value=this.value:this._inputElement.value="",this.notifyValueChanged()))}notifyValueChanged(){let o=null;o=new Event("input",{bubbles:!0,composed:!0}),this.dispatchEvent(o)}firstUpdated(){this._label=new Eo(this.renderRoot.querySelector("input"),this.renderRoot),this._inputElement=this.renderRoot.querySelector("input")}handleInput(){this.value=this._inputElement.value}render(){return D`
    ...
    `}}customElements.define("bsi-input",Ao);var _o=e`/***************************** 1 ****************************************/
/***************************** 2 ****************************************/
/***************************** 1 ****************************************/
/***************************** 2 ****************************************/
/***************************** 1 ****************************************/
...
.bg-dark .btn-outline-secondary:not(:disabled):not(.disabled).active, .bg-dark .btn-outline-secondary:not(:disabled):not(.disabled):active, .show > .bg-dark .btn-outline-secondary.dropdown-toggle {
  box-shadow: none;
}`;class Uo extends no{static styles=_o;static properties={type:{type:String},variant:{type:String},_buttonClasses:{type:String},outline:{type:Boolean},disabled:{type:Boolean}};constructor(){super(),this.type="button",this.variant="",this.outline=!1,this.disabled=!1}firstUpdated(){this._buttonClasses=this._composeClass("btn",this.outline?"":""!==this.variant?`btn-${this.variant}`:"",this.outline?`${this.outline?"btn-outline-":""}${this.variant}`:"",this.disabled?"disabled":"")}updated(){this._buttonClasses=this._composeClass("btn",this.outline?"":""!==this.variant?`btn-${this.variant}`:"",this.outline?`${this.outline?"btn-outline-":""}${this.variant}`:"",this.disabled?"disabled":"")}render(){return D`
      <button type="${this.type}" class="${this._buttonClasses}">
        <slot></slot>
      </button>
    `}}customElements.define("bsi-button",Uo);export{zo as BackToTop,Uo as Button,bo as Icon,Ao as Input};
